            ...
            {projects.map((project)=>(
              <div className="lg:w-[400px] w-full" key={project.name}>
                ...
                <div className="mt-5 flex flex-col">
                  <h4 className="text-2xl font-poppins font-semibold text-black">
                    {project.name}
                  </h4>
